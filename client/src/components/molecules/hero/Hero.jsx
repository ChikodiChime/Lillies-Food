  ...
  return (
    <>
      <div className='w-full ' style= {heroBg}>
        <div className=' h-full flex items-center pl-40 ' data-aos = 'fade-right'>
      ...
      <div className="w-full h-lvh " style={bg2}>
        ...
        <div className="text-black leading-loose text-xl pr-40  float-right w-1/2 h-full flex flex-col justify-center" data-aos = 'fade-left'>
