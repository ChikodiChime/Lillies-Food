...
const Delivery = () => {
  ...
  return (
    ...
    <div className=" w-full flex flex-col-reverse sm:flex-row px-20  lg:px-40 py-12 items-center justify-center bg-[conic-gradient(at_top_right,_var(--tw-gradient-stops))] from-red-500 via-red-600 to-red-500" >
        <div className="left w-full sm:w-1/2 text-center sm:text-left " data-aos = 'fade-right'>
            <h1 className="text-white leading-tight pb-10 font-extrabold text-[4rem] md:text-[5rem]">We deliver throughout Enugu State</h1>
